...
-- Keybinds to navigate between windows (split view)
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      { -- If encountering errors, see telescope-fzf-native README for installation instructions
        ...
        -- condition: whether this plugin should be loaded
        ...
        on_init = function(client)
          ...
          client.config.settings.Lua = vim.tbl_deep_extend('force', client.config.settings.Lua, {
            ...
            workspace = {
              ...
              -- NOTE: this second version is a lot slower and will cause issues when working on your own configuration.
  ...
  { -- Autocompletion
    ...
    opts = {
      ...
      fuzzy = {
        implementation = 'lua',
        sorts = require('custom.helpers').blinkFuzzySort,
      },
